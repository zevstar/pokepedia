...
const App = () => {
  ...
  const addToFavorites = (pokemon) => {
	  // When we click Like inside Pokemon List, send clicked Pokemon back to App.  Trigger this function to update our state. App will then pass our state as props to Favorites.
